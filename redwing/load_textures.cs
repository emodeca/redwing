...
namespace redwing
{
    public static class load_textures
    {
        ...
        public static void loadAllTextures()
        {
            foreach (var res in Assembly.GetExecutingAssembly().GetManifestResourceNames())
            {
                ...
                else if (res.Contains(soulPrefix))
                {
                    ...
                    else if (res.EndsWith("filledtwo.png")) SOUL_HOLDER[2] = loadImageFromAssembly(res);
                }
        ...
        private static void loadShieldTexture(int flameNum, string imageName)
        {
            Texture2D shieldTex;
            switch (flameNum)
            {
                case 0:
                    ...
                    return;
                case 1:
                    shieldTex = loadImageFromAssembly(imageName);
        ...
        {
            var dataStream = Assembly.GetExecutingAssembly().GetManifestResourceStream(filename);
