...
namespace redwing
{
    ...
    public class redwing_global_settings : IModSettings
    {
        ...
        public bool redwingFirstLaunch
        {
            get => GetBool();
            set => SetBool(value);
        }
        ...
        public bool overrideBlackmothNailDamage
        {
            get => GetBool();
        ...
        public bool overrideBlackmothLore
        {
            get => GetBool();
            private set => SetBool(value);
        }
        ...
        public bool overrideBlackmothCloak
        {
            get => GetBool();
            set => SetBool(value);
        }
        ...
        public bool useGreymothDashWhenBlackmothMissing
        {
            get => GetBool();
            private set => SetBool(value);
        }
        ...
        public bool applyBindingsToRedwingAttacks
        {
            get => GetBool();
            private set => SetBool(value);
        }
        ...
        public bool applyNailBindingToRedwingAttacks
        {
            get => GetBool();
            private set => SetBool(value);
        }

        public bool applyCharmBindingToGreymoth
        {
            get => GetBool();
            private set => SetBool(value);
        }

        public bool applySoulBindingToNapalm
        {
            get => GetBool();
            private set => SetBool(value);
        }

        public bool applyHealthBindingToShield
        {
            get => GetBool();
            private set => SetBool(value);
        }
        ...
        public bool handicapAllNonFireAttacks
        {
            get => GetBool();
            private set => SetBool(value);
        }

        public bool useEnglishWarningInfoWhenLanguageMissing
        {
            get => GetBool();
            private set => SetBool(value);
        }

        public bool useEnglishLoreWhenLanguageMissing
        {
            get => GetBool();
            private set => SetBool(value);
        }
        ...
        public int nailmasterGloryCost
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int fireballDamageBase
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int fireballDamagePerNailLvl
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int fireballMagmaDamageBase
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int fireballMagmaDamagePerNailLvl
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int fireballSoulAddOnHit
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int laserDamageBase
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int laserDamagePerNailLvl
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int pillarDamageBase
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int pillarDamagePerNailLvl
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int pillarSecondaryDamageBase
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int pillarSecondaryDamagePerNailLvl
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int pillarSecondaryAttacks
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int trailDamageBase
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int trailDamagePerNailLvl
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int trailSecondaryDamageBase
        {
            get => GetInt();
            private set => SetInt(value);
        }

        public int trailSecondaryDamagePerNailLvl
        {
            get => GetInt();
            private set => SetInt(value);
        }
        ...
        public bool lasersWhenShieldBlocksAllDmg
        {
            get => GetBool();
            private set => SetBool(value);
        }

        public float fireballCooldownBase
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float laserCooldownBase
        {
            get => GetFloat();
            private set => SetFloat(value);
        }
        ...
        public float shieldCooldownReductionPerNailHit
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float napalmDamageExponent
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float napalmDamageMultiplier
        {
            get => GetFloat();
            private set => SetFloat(value);
        }
    ...
    public class redwing_flamegen_settings : IModSettings
    {
        ...
        public float flameColor1Threshold
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorR1
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorG1
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorB1
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColor2Threshold
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorR2
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorG2
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorB2
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColor3Threshold
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorR3
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorG3
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorB3
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColor4Threshold
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorR4
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorG4
        {
            get => GetFloat();
            private set => SetFloat(value);
        }

        public float flameColorB4
        {
            get => GetFloat();
            private set => SetFloat(value);
        }
